...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content mdl-color--grey-100">
        ...
        <div class="demo-container mdl-grid">
            ...
            <!-- insert repo list start -->

            <ul class="demo-list-three mdl-list">

                <li class="mdl-list__item mdl-list__idem-- mdl-list__item--six-line mdl-color--yellow">
      ...
      <i class="fa fa-github fa-5x" aria-hidden="true"></i>
        ...
        <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
            ...
            <div class="mdl-card__actions">
                <a href="issue.html" class="mdl-button">open this issue</a>
            </div>
        </div>
                ...
                <ul class="demo-list-three mdl-list">
                    ...
                    <li class="mdl-list__item mdl-list__item--six-line mdl-color--yellow">
    <span class="mdl-list__item-primary-content">
      <i class="fa fa-github fa-5x" aria-hidden="true"></i>
