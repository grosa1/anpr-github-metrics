...
<!-- STATIC CSS IMPORT - TO REMOVE IN FULL PAGE RENDERING -->
<style>
                    ...
                    <span class="mdl-list__item-primary-content">
                        ...
                        <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                            ...
                            <div class="mdl-card__actions">
                                <a href="/zeus/dashboard" class="mdl-button">select issue</a>
                            </div>

                            <!-- SET ISSUE PAGE REQUEST -->
                                <%--<form action="${pageContext.request.contextPath}/set-repo" method="GET"--%>
                                      <%--class="mdl-card__actions">--%>
                                        <%--<input hidden="true" name="repo_json"--%>
                                               <%--value="<c:out value="${repo.serialize()}"/>"/>--%>
