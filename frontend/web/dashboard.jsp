<%@ page import="it.unimol.anpr_github_metrics.dashboard.DashboardController" %>
<!doctype html>
<!--
...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <div class="demo-drawer mdl-layout__drawer mdl-color--cyan mdl-color-text--white">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey">
            ...
            <form class="mdl-navigation__link" action="${pageContext.request.contextPath}/dashboard" method="GET">
                <i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">
                    <input hidden="true" name="page" value="<%=DashboardController.TICKETS%>"/>
                    <input type="submit" name="submit" value="Tickets"/>
                </i>
            </form>
