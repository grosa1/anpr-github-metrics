...
public class RecommenderApi {
    ...
    @GET
    @Path("/get-assignees-for-issues/{login-name}/{repository-name}/{issue-number}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getRecommendedUsers(@PathParam("repository-name") String repoPath, @PathParam("login-name") String loginName, @PathParam("issue-number") int issueNumber, @Context HttpServletRequest request) {
